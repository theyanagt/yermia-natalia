...
global.sig = 'https://instagram.com/ahyanmhmmd' // ig
global.sgh = '-' // github
global.sgc = 'https://chat.whatsapp.com/HyiaQnJAhC0HKVT0gEHH1X' // group whatsapp
global.sdc = '-'//discord
...
/*============== PAYMENT ==============*/
global.pdana = '0858-4937-3648' //dana
/*global.povo = '62895604670507' //ovo*/
global.pgopay = '0812-5893-0466' //gopay
...
/*============== Github Thanks To ==============*/
global.namagithub = 'AHYANMHMMD' // nama github lu
...
global.owner = [
  ...
  ['62881027428289', 'Lix', true],
  ['6282135203167', 'Zuly', true],
    //Ganti jd nomormu sama Namamu
  // [number, dia creator/owner?, dia developer?]
] // Put your number here
global.mods = ['628884357769', '62881027428289'] // Want some help?
global.prems = ['628884357769', '62881027428289'] // Premium user bukan disini nambahinnya, ketik .addprem @user 10
...
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝙔𝘼𝙉𝙕𝙈𝙄𝘼𝘽𝙊𝙏𝙕 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 𝙔𝘼𝙉𝙕𝙈𝙄𝘼𝘽𝙊𝙏𝙕 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By 𝙔𝘼𝙉𝙕X𝙈𝙄𝘼`
global.packname = '𝙔𝘼𝙉𝙕𝙈𝙄𝘼𝘽𝙊𝙏𝙕 WhatsApp'
global.author = '                「 𝙔𝘼𝙉𝙕𝙈𝙄𝘼𝘽𝙊𝙏𝙕  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = '𝙔𝘼𝙉𝙕𝙈𝙄𝘼𝘽𝙊𝙏𝙕'
global.stickauth = `By ©𝙘𝙤𝙥𝙮𝙧𝙞𝙜𝙝𝙩 𝘼𝙃𝙔𝘼𝙉 𝙉𝘼𝙆𝘼𝙈𝘼 X YERMIA NATALIA`
