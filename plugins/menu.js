...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'berita', 'edukasi', 'news', 'random', 'logo', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'sekolah', 'downloader', 'tools', 'fun', 'database','quran', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner']
...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `🌎 ${pmenus} Logo`, rowId: ".? logo", description: "Cari logo"},
        ...
        {title: `✏️ ${pmenus} sekolah`, rowId: ".? sekolah", description: "FITUR SEKOLAH NYA CUG!"},
...
const listMessage = {
 ...
 let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
  ...
  "businessOwnerJid": `${m.sender.split`@`[0]}@s.whatsapp.net`
    ...
    conn.reply(m.chat, '*TUNGGUIN BENTAR CUG. . .*', ftrol) 
